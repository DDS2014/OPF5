...
public class PruebasDeEnvioDeNotificaciones {
  ...
  public void CuandoUnPartidoEsConfirmadoElAdministradorEsNotificado() {
    ...
    final DistribuidorStub mockedDistribuidor = Mockito.<DistribuidorStub>mock(DistribuidorStub.class);
    ...
    DistribuidorStub _verify = Mockito.<DistribuidorStub>verify(mockedDistribuidor, _times);
    String _any = Matchers.<String>any(String.class);
    String _any_1 = Matchers.<String>any(String.class);
    String _any_2 = Matchers.<String>any(String.class);
    _verify.enviarMail(_any, _any_1, _any_2);
  }
