...
import domain.notificaciones.NotificarAdminDecorator;
import domain.notificaciones.NotificarAmigosDecorator;
...
public class PruebasDeEnvioDeNotificacionesMedianteDecorator {
  @Test
  ...
  public void CuandoUnPartidoEsConfirmadoElAdministradorEsNotificado() {
    try {
      ...
      NotificarAdminDecorator _notificarAdminDecorator = new NotificarAdminDecorator(partido);
      partido = _notificarAdminDecorator;
      NotificarAmigosDecorator _notificarAmigosDecorator = new NotificarAmigosDecorator(partido);
      partido = _notificarAmigosDecorator;
